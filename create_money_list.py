...
new_body = """<div class="article-body">
          ...
          <ul>
            ...
            <li><i>Myth 4: The Tour Championship payout is completely unofficial.</i> False. <a href="/news-every-shot-tiger-woods-80th-win-2018">Unlike the 2018 format</a>, the 2026 Tour Championship awards official money ($10M to the winner) separate from the bonus structure.</li>
          </ul>
          ...
          <section class="sources" aria-labelledby="sources-label">
            ...
            <ol>
              ...
              <li><a href="/news-every-shot-tiger-woods-80th-win-2018">Tiger Woods' 80th Win</a>. Understanding the historical context of Tiger's earnings dominance.</li>
            </ol>
          </section>
          ...
          <aside class="related" aria-label="Related GolfRaw reporting">
            ...
            <ul>
              ...
              <li><a href="/news-every-shot-tiger-woods-80th-win-2018">Tiger Woods 80th Win Retrospective</a></li>
