...
(function (root, doc) {
  ...
  function injectCss() {
    ...
    var css = [
      ...
      '.gr-lk-launch:focus-visible{outline:3px solid #15803d;outline-offset:3px}',
      ...
      '.gr-lk-x:focus-visible{outline:3px solid #15803d;outline-offset:2px}',
      ...
      'color:' + INK + ';border:1px solid #cbd5e1;border-radius:10px;font:600 15px/1.2 Archivo,system-ui,sans-serif}',
      '.gr-lk-f input:focus,.gr-lk-f select:focus{outline:3px solid #15803d;outline-offset:2px;border-color:#15803d}',
      ...
      '.gr-lk-btn:focus-visible{outline:3px solid #15803d;outline-offset:2px}',
