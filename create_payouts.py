...
hero_html = """
        <figure class="lead-img">
          ...
          <figcaption>SCOTTIE SCHEFFLER COLLECTS $10 MILLION AND PASSES TIGER WOODS ON THE ALL-TIME MONEY LIST AFTER WINNING THE 2026 TOUR CHAMPIONSHIP AT EAST LAKE. PHOTO: RAWGOLF</figcaption>
        </figure>
"""
...
new_vis_bc = """<nav class="crumbs" aria-label="Breadcrumb">
          <a href="/">RawGolf</a> / <a href="/pga-tour">PGA Tour</a> / <span>Tour Championship Points and Payouts</span>
        </nav>"""
...
html = re.sub(r'<h2 class="subhead">.*?</h2>', '<h2 class="subhead">Scheffler took $10M, seven men split $11.95M, and $355,000 went nowhere. Full table, plus the figure two official pages disagree on.</h2>', html, flags=re.DOTALL)
