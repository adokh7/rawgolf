...
| `guides.html`, `liv-golf.html`, `pga-tour.html`, `players.html`, `tournaments.html`, `vintage-golf-history.html` | filtered by `section` |
...
extractor; run the builder, then `wire_locker.py`, then `apply_theme.py`). The
