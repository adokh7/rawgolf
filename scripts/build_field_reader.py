    ...
    <div class="wrap">
      ...
      <section class="answer-block" aria-labelledby="aeo-q">
        ...
        <blockquote>Course fit is the idea that a course <b>rewards particular skills more than others</b>.
          ...
          against those weights, and the ranking that falls out is the fit. The
          <a href="/news-2026-the-renaissance-club-course-guide">course-fit example</a> shows how a real
          layout can reward a very specific mix of skills.</blockquote>
      </section>
