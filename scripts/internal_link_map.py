...
CONTEXTUAL_LINKS = (
    ...
    _link("/tools-scorecard-analyzer", "/news-2026-raw-golf-honest-practice-guide", "honest practice guide", "tool_to_guide"),
    _link("/tools-scorecard-analyzer", "/guides-the-three-feet-that-decide-whether-you-three-putt", "three-putt guide", "tool_to_guide"),
    ...
    _link("/golf-swing-drills", "/tools-scorecard-analyzer", "find the holes that cost you", "guide_to_tool"),
    ...
    _link("/news-2026-raw-golf-honest-practice-guide", "/tools-scorecard-analyzer", "round diagnosis", "guide_to_tool"),
