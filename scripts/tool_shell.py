...
The managed LOCKER, THEME, TOOL-EVENTS, UNITS, CONSENT-MODE and TOOL-ADS blocks are stripped from every part on purpose.
...
MANAGED = re.compile(r'\s*<!-- (LOCKER|THEME|TOOL-EVENTS|UNITS|CONSENT-MODE|TOOL-ADS):START -->.*?<!-- \1:END -->\n?', re.S)
